...
class Features extends BackEndController
{
    ...
    public function __construct()
    {
        ...
        $this->index_title = lang('Features');
        $this->add = lang('Add');
    ...
    public function index() {
        ...
        if(is_numeric($active)) {
            if(!$this->shop_type_model->find_first($active)) {
                throw_on_404();
            }
        }
    ...
    public function item($id = 0)
    {
        ...
        $item = $this->example_model->find_first($id);
        ...
        $this->data['title'] = 'Редактирование ' . $item->titleRO;
