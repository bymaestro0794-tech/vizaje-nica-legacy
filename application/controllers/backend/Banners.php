...
class Banners extends BackEndController {
    ...
    public function index() {
        ...
        $objects = $this->banners_model->find();
    ...
    public function put() {
        ...
        try {
            ...
            if (!$this->banners_model->put($post)) {
    ...
    public function update_order() {
        ...
        try {
            ...
            if (!$this->banners_model->update_sorder($post)) {
                throw new Exception(lang('Error writing data to table') . $this->main_page);
            }
    ...
    public function item($id = 0) {
        ...
        init_load_img($this->main_page);
        $item = $this->banners_model->find_first($id);
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            try {
                ...
                if (!$this->banners_model->update($post, $id)) {
                    throw new Exception(lang('Error writing data to table') . $this->main_page);
                }
