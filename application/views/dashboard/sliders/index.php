                                    ...
                                    <div class="table-scrollable">
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="color" name="ColorText" style="max-width: 80px" value="#1e0f0f"
                                                           class="form-control" >
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="color" name="ColorButton" style="max-width: 80px" value="#1e0f0f"
                                                           class="form-control" >
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="color" name="ColorButtonText" style="max-width: 80px" value="#1e0f0f"
                                                           class="form-control" >
                                                </td>
                                            </tr>
                                            <? foreach (language(true) as $lang) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="file" name="imgMob" id="file" class="form-control" required>
                                                    <div class="note note-warning"
                                                         style="margin-bottom: 0px; margin-top: 10px;">
                                                        <p>
