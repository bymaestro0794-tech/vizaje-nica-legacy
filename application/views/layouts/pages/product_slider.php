...
$productBrand = (string) ($item->brand_title ?? '');
...
|--------------------------------------------------------------------------
|
| Для вариативного товара используем effective_* поля выбранного варианта.
| Для обычного товара — стандартные поля родителя.
|
*/
...
$notificationPrice = number_format(
	$currentPrice,
	0,
	'.',
	' '
